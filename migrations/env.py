...
# Используем DATABASE_URL из настроек (переменные окружения имеют приоритет)
# settings.database_url читает переменную окружения DATABASE_URL, если она установлена
